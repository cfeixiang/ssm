...
<div class="page-header">
    <h1>注册账号</h1>
    <h3 style="color:red;"><%=request.getParameter("registerInfo")==null?"":request.getParameter("registerInfo")%></h3>
</div>
<form id="user" action="${pageContext.request.contextPath}/user/register" method="post" >
    ...
    <button type="submit" id="registerBtn"  class="btn btn-primary" onclick="location.href='${pageContext.request.contextPath}/user/register-ui'">注册</button>
    &nbsp;&nbsp;&nbsp;
