...
<button style="width: 100px;height: 30px;margin-left: 50%" onclick="location.href ='${pageContext.request.contextPath}/user/register-ui'" class="btn btn-primary">注册账号</button>
</body>
